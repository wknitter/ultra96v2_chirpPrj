...
import "DPI-C" function void ps8_simulate_single_cycle_pl_clk3();
...
//INITIAL BLOCK
  ...
  always #(5.0) pl_clk3 <= ~pl_clk3;

  always@(posedge pl_clk3)
  begin
   ps8_set_ip_context(ip_name);
   ps8_simulate_single_cycle_pl_clk3();
  end
