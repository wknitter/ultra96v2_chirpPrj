...
# ----------------------------------------------------------------------------
# Bank 26
#set_property PACKAGE_PIN C8 [get_ports BT_AUD_CLK]     
#set_property PACKAGE_PIN A8 [get_ports BT_AUD_FSYNC]  
#set_property PACKAGE_PIN A9 [get_ports BT_AUD_IN]   
#set_property PACKAGE_PIN B9 [get_ports BT_AUD_OUT] 
...
set_property DRIVE 8 [get_ports FAN_PWM_tri_o]
